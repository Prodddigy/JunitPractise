...
public class Account {
	 ...
	 */
	public void tick() {//error
		/**
		 * there should be only 1 tp.tick() invocation
		 * otherwise money transfer is duplicated
	 ...
	 */
	public Integer getBalance() {//error
		/**
		 * this method should return Integer of amount rather then the Money object
		 */

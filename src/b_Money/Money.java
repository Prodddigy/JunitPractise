...
public class Money implements Comparable {
	...
	public Integer universalValue() {
		return this.currency.universalValue(this.getAmount());
	}
	...
	public Boolean equals(Money other) {
		return Objects.equals(this.currency.universalValue(this.getAmount()), other.currency.universalValue(other.getAmount()));
	}
	...
	public Money add(Money other) {
		int newAmount = ((this.getAmount()) + this.getCurrency().valueInThisCurrency(other.getAmount(),other.getCurrency()));
		//System.out.println(((this.getAmount()) + this.getCurrency().valueInThisCurrency(other.getAmount(),other.getCurrency()))+"Money");

		return new Money(newAmount*100,this.currency);
	}
	...
	public Money negate() {
		...
		return new Money(-this.getAmount()*100,this.getCurrency());
	}
	...
	public int compareTo(Object other) {
		...
		if(Objects.equals(this.currency.universalValue(this.getAmount()), obj.currency.universalValue(obj.getAmount())))
		{
			return 0;
		} else if (this.currency.universalValue(this.getAmount()) > obj.currency.universalValue(obj.getAmount())) {
			return 1;
		}
		else {
			return -1;
